package me.dreamdevs.dreamutils.inventory;
...
import me.dreamdevs.dreamutils.DreamCore;
import me.dreamdevs.dreamutils.inventory.buttons.MenuItem;
...
public class ItemMenu {
	...
	public void open(Player player) {
		if (!ItemMenuListener.getInstance().isRegistered(DreamCore.getPlugin())) {
			ItemMenuListener.getInstance().register(DreamCore.getPlugin());
		}
		inventory = Bukkit.createInventory(new ItemMenuHolder(this, Bukkit.createInventory(player, size.getSize())), size.getSize(), name);
		apply(inventory);
